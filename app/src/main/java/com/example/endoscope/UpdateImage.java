...
//更新图片
public class UpdateImage extends Activity implements  topbarClickListener {
	Topbar mTopbar;
	...
	String PatientNO, patientName,result,symptom,Did,diagnosis_date;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.updateimage);
		...
		diagnosis_date= bund.getString("date");
	...
	public void leftClick() {
		Intent intent = new Intent(this, UpdateDiagnosisActivity.class);
	...
	public void rightClick() {
		if (PatientNO != null) {
			...
			if (spStr.length > 3) {
				//弹出提示框
				Dialog dialog = new AlertDialog.Builder(UpdateImage.this)
